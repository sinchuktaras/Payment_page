...
const PaymentForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setMessage("✅ Платіж успішний! Дякуємо.");
      // Очистимо поля
      setCardNumber("");
      setExpiry("");
      setCvc("");
  ...
  return (
    <div className="payment-container">
      ...
      <p className="info">
        You’ll have your Plan Pro during 1 year. After this period of time, your
        plan will be automatically renewed with its original price without any
        discounts applied.
      </p>
    </div>
  );
